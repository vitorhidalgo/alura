...
System.register(['../models/ListaNegociacoes', '../models/Mensagem', '../views/NegociacoesView', '../views/MensagemView', '../services/NegociacaoService', '../helpers/DateHelper', '../helpers/BindHelper', '../models/Negociacao'], function (_export, _context) {
	"use strict";

	var ListaNegociacoes, Mensagem, NegociacoesView, MensagemView, NegociacaoService, DateHelper, BindHelper, Negociacao, _createClass, NegociacaoController, negociacaoController;
	...
	return {
		...
		}, function (_helpersBindHelper) {
			BindHelper = _helpersBindHelper.BindHelper;
		...
		execute: function () {
			...
			_export('NegociacaoController', NegociacaoController = function () {
				function NegociacaoController() {
					...
					this._listaNegociacoes = new BindHelper(new ListaNegociacoes(), new NegociacoesView($('#negociacoesView')), 'adiciona', 'esvazia', 'ordena', 'inverterOrdem');
				...
				_createClass(NegociacaoController, [{
					...
					value: function _init() {
						...
						this._service.lista().catch(function (erro) {
							console.log(erro);
